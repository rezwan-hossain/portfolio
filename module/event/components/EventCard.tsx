  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 lg:gap-8">
      ...
      <div className="lg:col-span-2 border border-gray-400 rounded-2xl p-8 md:p-10 flex flex-col justify-between bg-card">
        <div>
          <h2 className="text-3xl md:text-4xl uppercase tracking-tight text-card-foreground leading-tight">
            {title}
          </h2>
          <p
            className={`mt-3 text-sm md:text-base leading-relaxed inline ${
              highlighted
